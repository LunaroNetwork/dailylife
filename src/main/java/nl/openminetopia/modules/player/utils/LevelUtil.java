...
public class LevelUtil {
    ...
    public int calculateLevel(MinetopiaPlayer minetopiaPlayer) {
        ...
        BankAccountModel accountModel = DailyLife.getModuleManager().get(BankingModule.class).getAccountById(minetopiaPlayer.getUuid());
        ...
        if (player == null) return DailyLife.getDefaultConfiguration().getDefaultLevel();
        ...
        level = Math.max(DailyLife.getDefaultConfiguration().getDefaultLevel(),
    ...
    public CompletableFuture<Double> calculateLevelupCosts(int currentLevel, int newLevel) {
        LevelCheckConfiguration configuration = DailyLife.getModuleManager().get(PlayerModule.class).getConfiguration();
